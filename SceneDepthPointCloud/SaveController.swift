...
class SaveController : UIViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate {
    ...
    override func viewDidLoad() {
        ...
        fileTypeWarning.text = "Suporta apenas o formato .ply."
        ...
        fileNameInput.placeholder = "Nome do Arquivo"
        ...
        saveCurrentScanLabel.text = "Scan Atual: \(mainController.renderer.highConfCount) pontos"
        ...
        saveCurrentButton.setTitle("Salvar Scan Atual", for: .normal)
        ...
        goToExportViewButton.setTitle("Scans Salvos Anteriormente", for: .normal)
